...
from traxis.graphics import markers, angleref, fittedarc, JSONHandler
...
class GuiSkeleton(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.saveSessionButton.setText("Save As")
        ...
        self.loadSessionButton.setText("Load Session")
        self.loadSessionButton.setToolTip(
            "Load a previously saved analysis session")

        self.LoadFolderbutton = QtWidgets.QPushButton(self)
        self.saveLayout.addWidget(self.LoadFolderbutton)
        # don't focus on this widget when clicked
        self.LoadFolderbutton.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        # Current folder list GUI segment
        self.JSONLayout = QtWidgets.QVBoxLayout()  # JSON segment layout
        self.topUiLayout.addLayout(self.JSONLayout)

        self.JSONLabel = QtWidgets.QLabel(self)  # JSON label
        self.JSONLayout.addWidget(self.JSONLabel)
        self.JSONLabel.setText("Saved Sessions")

        # JSON text browser widget
        self.JSONTextBrowser = JSONHandler.JSONSessions(self)
